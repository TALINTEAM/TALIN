...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./TALIN.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("TN", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S TALIN -X kill
screen -S TALIN ./TALIN
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TALINTEAM/Files_TALIN/master/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(1075684463) then  
var = true  
...
local TALIN_Msg = ''  
if msgs < 100 then 
TALIN_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
TALIN_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
TALIN_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
TALIN_Msg = 'متفاعل' 
elseif msgs < 1200 then 
TALIN_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
TALIN_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
TALIN_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
TALIN_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
TALIN_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
TALIN_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
TALIN_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
TALIN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
TALIN_Msg = 'رب التفاعل'  
end 
return TALIN_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceTALIN(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,TALIN_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf TALIN.lua')
os.execute('wget https://raw.githubusercontent.com/TALINTEAM/TALIN/main/TALIN.lua')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..TALINk..''..TALIN..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'Source_TAlin')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_TAlin')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
local TALIN1_Msg = database:get(bot_id.."TALIN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if TALIN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_TAlin')..') \n ❃∫ '..TALIN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if TALIN_Msg and not Special(msg) then  
local TALIN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if TALIN_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..TALIN_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/Source_TAlin)}\n ❃∫ ["..TALIN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/Source_TAlin)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Source_TAlin')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Source_TAlin')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_TAlin')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_TAlin')..')'
...
database:set(bot_id.."TALIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."TALIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."TALIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TALIN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TALIN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."TALIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."TALIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TALIN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TALIN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TALIN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."TALIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."TALIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."TALIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TALIN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TALIN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."TALIN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."TALIN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TALIN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TALIN1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝐓𝐍━━━━━━≫\n"
for k,v in pairs(list) do  
local TALIN_Msg = database:get(bot_id.."TALIN1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..TALIN_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Source_TAlin')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..TALIN_Msg[math.random(#TALIN_Msg)]..']') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Source_TAlin')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
TALINdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
*❃م10 ◂ اوامر الاعضاء*
ٴ≪━━━━━━𝐓𝐍━━━━━━≫ٴ
彡 .[¹# 𝞝 𝙏 𝘼 𝙇 𝙄 𝙉](t.me/Source_TAlin)➢ 
]]
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝐓𝐍━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[¹# 𝞝 𝙏 𝘼 𝙇 𝙄 𝙉](t.me/Source_TAlin)➢ ')
end
...
TALIN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(TALIN)
...
--------------------------------------------------------------------------------------------------------------
SourceTALIN(data.message_,data)
...
------------------------------------------------------------------------
local TALINAbot = database:get(bot_id.."TALIN1:Add:Filter:Rp2"..text..result.chat_id_)   
if TALINAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..TALINAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local TALIN1_Msg = database:get(bot_id.."TALIN1:Add:Filter:Rp2"..text..result.chat_id_)   
if TALIN1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..TALIN1_Msg)
